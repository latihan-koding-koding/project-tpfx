...
const CrudeOilBanner = ({ onClickBtn }: { onClickBtn: () => void }) => {
  return (
  ...
  return (
    <div>
      <Layout>
        ...
        <CrudeOilBanner onClickBtn={navigateToRegist} />
        ...
        <Section className="bg-secondary-gold-5 py-24">
          <div className="grid lg:grid-cols-2 gap-6">
            ...
            <div className="mx-auto">
              <Image
                src="/images/instrument/crude_1.png"
                width={639}
                height={501}
                alt="CrudeOil-img-1"
              />
        ...
        <Section className="bg-secondary-gold-5 py-24">
          <div className="grid grid-cols-2 gap-20">
            <div className="mx-auto">
              <Image
                src="/images/instrument/crude_2.png"
                width={576}
                height={328}
                alt="CrudeOil-img-2"
              />
